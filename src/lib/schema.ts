export function getLegalServiceSchema() {
  return {
    ...
    "@type": "LegalService",
    "@id": "https://diogoemezeiro-adv.vercel.app/#legalservice",
    ...
    "priceRange": "$$",
    "image": "https://diogoemezeiro-adv.vercel.app/logo_semfundo_preta.png",
    "logo": "https://diogoemezeiro-adv.vercel.app/logo_semfundo_preta.png",
    "address": {
      "@type": "PostalAddress",
